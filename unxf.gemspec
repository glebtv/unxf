Gem::Specification.new do |s|
  ...
  s.description = 'Rack middleware to remove "HTTP_X_FORWARDED_FOR" in the Rack environment and replace "REMOTE_ADDR" with the value of the original client address.'
